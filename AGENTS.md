...
- **Script anti-repetition:** style snippets from recent transcripts + daily intro/outro moves + hard outro-mold validators. See `docs/solutions/best-practices/script-anti-repetition-style-memory.md`.
