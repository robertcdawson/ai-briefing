...
export const SPEAKER_PROFILES: Record<SpeakerId, SpeakerProfile> = {
  ...
  analyst: {
    ...
    role: "Analyst",
    persona:
      "The Analyst is warmer and more curious, driving at why a story matters, pressing for consequences, and unafraid to push back on the Anchor when a take feels too tidy.",
    delivery:
